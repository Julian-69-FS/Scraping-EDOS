...
class ReglamentoProcessor:
    ...
    def __init__(self, input_folder: str, output_folder: str):
        ...
        self.url_json_path = Path(r"C:\Users\julii\Documents\Practicas\drive\EDOMEX\json\A1 METADATOS\reglamentos_leyes_federales.json")# metadatos
        self.url_data = None

        # Ruta del JSON con contenidos
        self.contenido_json_path = Path(r"C:\Users\julii\Documents\Practicas\drive\EDOMEX\json\B1 CONTENIDO\RLF-contenido.json")#contenidos de los PDFs
    ...
    def extract_fecha_publicacion(self, text: str) -> Optional[str]:
        ...
        Busca patrones como: "publicado en el Diario Oficial de la Federación el 21 de diciembre de 2011"
        """
        if not text:
            return None
        ...
        # Patrones para detectar la fecha de publicación
        patrones = [
            r'publicado\s+en\s+el\s+Diario\s+Oficial\s+de\s+la\s+Federaci[oó]n\s+el\s+(\d{1,2}\s+de\s+\w+\s+de\s+\d{4})',
            r'publicado\s+en\s+el\s+DOF\s+el\s+(\d{1,2}\s+de\s+\w+\s+de\s+\d{4})',
    ...
    def process_single_pdf(self, pdf_path: Path) -> Dict[str, Any]:
        ...
        result = {
            ...
            'ordenamiento': 'REGLAMENTOS DE LEYES FEDERALES',  # Tipo de ordenamiento
            'jurisdiccion': 'ESTADO DE MÉXICO',  # Jurisdicción
            'fuente_oficial': 'DIARIO OFICIAL DE LA FEDERACIÓN',  # Fuente oficial
        ...
        try:
            ...
            # 5. Detectar status del documento (Vigente/Abrogada) y extraer fecha
            ...
            return {
                ...
                'ordenamiento': 'REGLAMENTOS DE LEYES FEDERALES',
                'jurisdiccion': 'ESTADO DE MÉXICO',
                'fuente_oficial': 'DIARIO OFICIAL DE LA FEDERACIÓN',
...
def main():
    ...
    INPUT_FOLDER = r"C:\Users\julii\Documents\EDOMEX\REGLAMENTOS DE LEYES FEDERALES" # Carpeta con los PDFs
    OUTPUT_FOLDER = r"C:\Users\julii\Documents\Practicas\drive\EDOMEX\json\REGLAMENTOS DE LEYES FEDERALES"  # Misma carpeta que el script
