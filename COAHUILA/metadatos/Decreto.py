...
class ReglamentoProcessor:
    ...
    def __init__(self, input_folder: str, output_folder: str):
        ...
        self.contenido_json_path = Path(r"C:\Users\julii\Documents\Practicas\drive\COAHUILA\contenido\Decreto\Decreto-Legislativo-contenido.json")#contenidos de los PDFs
    ...
    def extract_fecha_publicacion(self, text: str) -> Optional[str]:
        ...
        patrones = [
            # Patrón 1: NUEVO - "[Ley/Código/Reglamento/etc.] publicada/o en el Periódico Oficial, el [día_semana] DD de mes de YYYY"
            ...
            # Patrón 2: NUEVO - Sin día de la semana
            ...
            # Patrón 3: NUEVO - Genérico "publicad[oa] en el Periódico Oficial"
    ...
    def process_single_pdf(self, pdf_path: Path) -> Dict[str, Any]:
        ...
        result = {
            ...
            'ordenamiento': 'Decreto Legislativo',  # Tipo de ordenamiento
            'jurisdiccion': 'COAHUILA',  # Jurisdicción
        ...
        try:
            ...
            return {
                ...
                'ordenamiento': 'Decreto Legislativo',
                'jurisdiccion': 'COAHUILA',
...
def main():
    ...
    INPUT_FOLDER = r"C:\Users\julii\Documents\COAHUILA DOF\Decreto Legislativo" # Carpeta con los PDFs
    OUTPUT_FOLDER = r"C:\Users\julii\Documents\Practicas\drive\COAHUILA\json\Decreto"  # Misma carpeta que el script
